class Menu:
    ...
    def fetch_elastic_data_between_ts1_ts2(self):
        ...
        filter_match_dict_list = self.converter.convert_match_to_list(filter_match_raw=filter_match_raw)
        ...
        data_json = self.request_sender.get_fetch_elastic_data_between_ts1_ts2(pit_id=pit_id, num_logs=num_logs,
                                                                          start_ts=start_ts, end_ts=end_ts, fields_list=fields_list, filter_match_dict_list=filter_match_dict_list)
